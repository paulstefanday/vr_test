...
var getOpposite = function (input, a, b) {
  if (input === a) return a;
  return b;
};
...
},{"yo-yo":11}],2:[function(require,module,exports){
var yo = require('yo-yo');
...
function addAnimation(el) {
	...
	var animation = function () {
		...
		bel0.setAttribute("to", "1.4 1.4 1.4");
...
AFRAME.registerComponent('cursor-listener', {
	init: function () {
		...
		this.el.addEventListener('mouseenter', function (e) {
			...
			var el_status = document.querySelectorAll('#question-response');
...
AFRAME.registerComponent('timer', {
	init: function () {
		...
		var duration = this.el.getAttribute('data-duration');
		...
		var animation = function () {
			...
			bel0.setAttribute("from", arguments[1]);
			bel0.setAttribute("to", "0");
			return bel0;
		}(duration, width);
...
var Game = function () {
	...
	this.question = function () {
		...
		for (var i = 0; i < questions[_this.step].choices.length; i++) {
			_this.choice(questions[_this.step].choices[i], delay);
			delay = delay + 500;
		}
	};

	this.choice = function (choice, delay) {
		...
		var entity = function () {
			...
			bel3.setAttribute("obj-model", "obj: #fly-a-obj; mtl: #fly-a-mtl");
			...
			bel3.setAttribute("sound", "src: #sound-eat; on: click");
			var bel0 = document.createElement("a-animation");
			bel0.setAttribute("attribute", "scale");
			bel0.setAttribute("dur", "200");
			bel0.setAttribute("fill", "forwards");
			...
			ac(bel3, ["\n\t\t\t\t\t\t", bel0, "\n\t\t\t\t\t\t", bel1, "\n\t\t\t\t\t\t", bel2, "\n\t\t\t\t"]);
			var bel7 = document.createElement("a-entity");
			bel7.setAttribute("clicked", "clicked");
			bel7.setAttribute("obj-model", "obj: #fly-b-obj; mtl: #fly-b-mtl");
			bel7.setAttribute("data-choice", arguments[13]);
			bel7.setAttribute("position", arguments[14] + " " + arguments[15] + " " + arguments[16]);
			bel7.setAttribute("scale", "0 0 0");
			bel7.setAttribute("rotation", arguments[17] + " " + arguments[18] + " " + arguments[19]);
			bel7.setAttribute("sound", "src: #sound-eat; on: click");
			var bel4 = document.createElement("a-animation");
			bel4.setAttribute("attribute", "scale");
			bel4.setAttribute("dur", "200");
			bel4.setAttribute("fill", "forwards");
			bel4.setAttribute("to", "1 1 1");
			bel4.setAttribute("repeat", "0");
			var bel5 = document.createElement("a-entity");
			bel5.setAttribute("data-choice", arguments[10]);
			bel5.setAttribute("material", "color: white");
			bel5.setAttribute("text", "text: " + arguments[11] + "; size: 0.24");
			bel5.setAttribute("position", "-0.2 0.1 0");
			var bel6 = document.createElement("a-box");
			bel6.setAttribute("data-choice", arguments[12]);
			bel6.setAttribute("cursor-listener", "cursor-listener");
			bel6.setAttribute("opacity", "0");
			ac(bel7, ["\n\t\t\t\t\t\t", bel4, "\n\t\t\t\t\t\t", bel5, "\n\t\t\t\t\t\t", bel6, "\n\t\t\t\t"]);
			ac(bel8, ["\n\t\t\t\t", bel3, "\n\n\t\t\t\t", bel7, "\n\t\t\t"]);
			return bel8;
		}(choice, choice, choice, choice, position.x, position.y - 0.1, position.z, rotation.x, rotation.y + 5, rotation.z - 3, choice, choice, choice, choice, position.x, position.y + 0.1, position.z, rotation.x, rotation.y - 5, rotation.z + 3);
	...
	this.timer = function () {
		...
		var timer = function () {
			...
			bel0.setAttribute("data-duration", arguments[0]);
			bel0.setAttribute("position", "0 0 0");
			bel0.setAttribute("height", "0.05");
			bel0.setAttribute("width", "0.8");
			return bel0;
		}(_this.duration);
		...
		setTimeout(_this.result, _this.duration);
	};
	...
	this.result = function () {
		...
		// update score
		var text = $('#endfish').children('')[0];
		$(text).attr('bmfont-text', 'text: ' + _this.score + ' Points!; color:white');
	...
	this.position = function () {
		...
		var position = {
			x: _this.getRand(-10, 10),
			y: _this.getRand(1, 3),
			z: _this.getRand(-2, -12)
		};

		return position;
	};

	this.rotation = function (position) {
		var rotation = {
			x: _this.getRand(-5, 5),
			y: position.x * -8,
			z: _this.getRand(-5, 5)
...
AFRAME.registerComponent('flapping', {
	init: function () {
		...
		setInterval(function () {
			var first = _this.el.children[0].getAttribute('visible');
			if (first === true) {
				_this.el.children[0].setAttribute('visible', false);
				_this.el.children[1].setAttribute('visible', true);
			} else {
				_this.el.children[1].setAttribute('visible', false);
				_this.el.children[0].setAttribute('visible', true);
			}
		}, Math.floor(Math.random() * (max + 1) + min));
	}
});
},{"./game/animation.js":1,"./game/events.js":2,"./game/index.js":3,"aframe-text-component":6,"yo-yo":11}],6:[function(require,module,exports){
/**
...
},{"./lib/FontUtils":7,"./lib/TextGeometry":8,"./lib/helvetiker_regular.typeface":9}],7:[function(require,module,exports){
/**
...
},{"./update-events.js":12,"morphdom":10}],12:[function(require,module,exports){
module.exports = [
