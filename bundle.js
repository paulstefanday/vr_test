...
var _templateObject = _taggedTemplateLiteral(['<a-animation attribute="scale" dur="200" fill="forwards" to="1.4 1.4 1.4" repeat="0"></a-animation>'], ['<a-animation attribute="scale" dur="200" fill="forwards" to="1.4 1.4 1.4" repeat="0"></a-animation>']),
    _templateObject2 = _taggedTemplateLiteral(['<a-animation attribute="scale" dur="200" fill="forwards" to="1 1 1" repeat="0"></a-animation>'], ['<a-animation attribute="scale" dur="200" fill="forwards" to="1 1 1" repeat="0"></a-animation>']);
...
function addAnimation(el) {
  var child = yo(_templateObject);
  el.appendChild(child);
}

function leaveAnimation(el) {
  el.innerHTML = '';
  var child = yo(_templateObject2);
  el.appendChild(child);
}
...
},{"yo-yo":17}],2:[function(require,module,exports){
var _templateObject = _taggedTemplateLiteral(['<a-entity cursor-listener obj-model="obj: #fly-b-obj; mtl: #fly-b-mtl" data-choice="', '" position="', ' ', ' ', '" scale="1 1 1" rotation="', ' ', ' ', '"></a-entity>'], ['<a-entity cursor-listener obj-model="obj: #fly-b-obj; mtl: #fly-b-mtl" data-choice="', '" position="', ' ', ' ', '" scale="1 1 1" rotation="', ' ', ' ', '"></a-entity>']);
...
var Game = function () {
	...
	this.question = function () {
		...
		for (var i = 0; i < questions[_this.step].choices.length; i++) {
			...
			var choice = questions[_this.step].choices[i];

			var entity = yo(_templateObject, choice, position.x, position.y, position.z, rotation.x, rotation.y, rotation.z);
...
},{"./questions":3,"yo-yo":17}],3:[function(require,module,exports){
module.exports = [{
	question: "5 x 5",
...
},{"./lib/FontUtils":6,"./lib/TextGeometry":7,"./lib/helvetiker_regular.typeface":8}],6:[function(require,module,exports){
/**
...
},{"global/document":11,"hyperx":14,"on-load":16}],10:[function(require,module,exports){
...
},{"min-document":10}],12:[function(require,module,exports){
(function (global){
...
},{"global/document":11,"global/window":12}],17:[function(require,module,exports){
...
},{"./update-events.js":18,"bel":9,"morphdom":15}],18:[function(require,module,exports){
module.exports = [
